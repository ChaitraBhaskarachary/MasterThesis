...
i = 80
for each_healthy in healthy_subjects[80:87]:
    print("*" * 100)
    print(i)
    ...
    print(path_Autism_data + each_autism)
    raw_Autism, eeg_chans = AT.autism_raw(subject=each_autism,path_absolute=path_Autism_data)
...
OFH.OFHandlers.save_object("test_combined_signal.file",concat_signal)
